...
<html>
<head>
    <title>${model.titleOfThePageCreatePerson}</title>
</head>
<body>
...
<div id="create-task-form">
    ...
    <a href='<c:url value="/task/create?lang=en"/>'>EN</a>
    <form action="<c:url value="/task/create?lang=${lang}"/>" method="post">
        <p>${model.textValueCreateATask}</p>
        ...
        <input type="submit" value="${model.submitCreate}">
